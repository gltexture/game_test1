...
public class ModelLoader {
    ...
    private static MeshDataGroup loadMesh(String modelPath) {
        ...
        final int FLAGS = Assimp.aiProcess_GenSmoothNormals | Assimp.aiProcess_JoinIdenticalVertices | Assimp.aiProcess_Triangulate | Assimp.aiProcess_FixInfacingNormals | Assimp.aiProcess_CalcTangentSpace | Assimp.aiProcess_LimitBoneWeights | Assimp.aiProcess_PreTransformVertices;
    ...
    private static Material readMaterial(AIMaterial aiMaterial, String fullPath) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            String metallic = ModelLoader.tryReadTexture(stack, aiMaterial, Assimp.aiTextureType_METALNESS);
