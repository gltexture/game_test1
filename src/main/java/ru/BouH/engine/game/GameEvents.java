...
public class GameEvents {
    ...
    public static void addBrushes(World world) {
        ...
        plane4dBrush.setMaterial(Materials.grassGround);
        ...
        plane4dBrush2.setMaterial(Materials.brickCube);
        ...
        plane4dBrush3.setMaterial(Materials.brickCube);
        ...
        plane4dBrush4.setMaterial(Materials.brickCube);
        ...
        plane4dBrush5.setMaterial(Materials.brickCube);
