package ru.BouH.engine.game.resource.assets.obj;
...
public class OBJLoader {
    public static MeshModel loadMesh(String path) {
        ...
        URL url = OBJLoader.class.getResource(fullPath);
        if (url != null) {
            try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(AssetsHelper.loadFile(fullPath)))) {
                String line;
